...
const testimonials = [
  ...
  },
  {
    ...
    quote: 'The support team is excellent and the product is very easy to use for all staff. The support team is excellent and the product is very easy to use for all staff. The support team is excellent and the product is very easy to use for all staff.',
    school: 'Sunrise Academy, UAE',
    schoolColor: 'text-[#f4473e]',
    button: true,
    buttonText: 'Read Full Story',
  },
